...
# Run training script
python3 -u $HOME/repos/picai_baseline/src/picai_baseline/unet/train.py --weights_dir $HOME/models/picai/unet/hp_exp17 --overviews_dir $TMPDIR/data/overviews/unet --folds 0 1 2 3 4 --num_epochs 100 --base_lr 0.01 --focal_loss_gamma 0 --use_def_model_hp 0 --model_strides "[(2, 2, 2), (1, 2, 2), (1, 2, 2), (1, 2, 2)]" --model_features "[32, 64, 128, 256, 512]"

## Changed model architecture to be shallower