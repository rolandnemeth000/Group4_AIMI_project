...
# Set up environment
cp $HOME/repos/AIMI_project/code/training_extensions/train_ext_focal.py $HOME/repos/picai_baseline/src/picai_baseline/unet/
...
# Run training script
python3 -u $HOME/repos/picai_baseline/src/picai_baseline/unet/train_ext_focal.py --weights_dir $HOME/models/picai/unet/hp_exp8 --overviews_dir $TMPDIR/data/overviews/unet --folds 0 1 2 3 4 --num_epochs 100 --base_lr 0.001
