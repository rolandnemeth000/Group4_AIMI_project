...
#overviews
python3 $HOME/repos/picai_baseline/src/picai_baseline/unet/plan_overview.py --task=Task0006_picai_hp_exp6 --workdir=$TMPDIR/data --preprocessed_data_path=$TMPDIR/data/preprocessed/nnUNet_raw_data/{task} --overviews_path=$TMPDIR/data/overviews/unet
...
# Run training script
python3 -u $HOME/repos/picai_baseline/src/picai_baseline/unet/train.py --weights_dir $HOME/models/picai/unet/hp_exp6 --overviews_dir $TMPDIR/data/overviews/unet --folds 0 1 2 3 4 --num_epochs 500 --base_lr 0.001 --focal_loss_gamma 0
